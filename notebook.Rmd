...
```
We got a R² of 0.9429 and a MSE of 246.1544, which is a bit worse.
...
### k_f-fold validation with k=5 In the k-fold validation, firtly we choose k = 5
...
We show directly how we use the LDA methods with K-Folds Cross validation to evaluate the error rate with the classification method. We use the `lda` function instead.
