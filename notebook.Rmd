...
As the ROC curves only show the goodness of a method between two classes, we would have to do class 1 against classes 2 and 3, class 2 against class 1 and 3, and class 3 against class 2 and 1, that would not give us the goodness of fit given by the methods we used to discriminate directly 3 classes. We then shall not use it.
